...
export default class ContractRegistry {
    ...
    private async deployContracts(): Promise<void> {
        ...
        [this._borrowedTokenAddress, this._ibTokenAddress, this._debtTokenAddress, this._lendingRateAddress, this._borrowingRateAddress, this._oracleGatewayAddress, this._collateralTokenAddress] = await Promise.all([
