...
contract Pool is ReentrancyGuard {
    ...
    function repay() public nonReentrant {
        ...
        // If bob borrowed 1 borrowed token, he must repay debt token / debt index at borrowing (equivalent to the number of borrowed token when bob
        // borrowed)
        ...
        console.log("totalDebtOwned: ", totalDebtOwned);
    ...
    function liquidate(address borrower) public nonReentrant {
        ...
        //(borrowerDebtBalance * DECIMALS) / debtToken.getDebtIndexAtBorrowing(borrower);
        totalBorrows -= borrowedPrincipalAmount;
